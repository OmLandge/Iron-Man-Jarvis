...
from Jarvis.features import covid_stats, date_time
from Jarvis.features import launch_app
from Jarvis.features import interaction
...
class JarvisAssistant:
    ...
    def covid_stats(self):
        ...
        :return: news list of string if True, False if fail
        """
        return covid_stats.get_covidStats()

    def interaction(self, command):
        return interaction.Fun(self, command)
